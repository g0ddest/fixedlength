...
public class FixedLength {
  ...
  private Object lineToObject(FixedFormatRecord record) {
    ...
    try {
      ...
      throw new FixedLengthException("Unable to instanciate " + clazz.getName(), e);
    }
  ...
  public List<Object> parse(InputStream stream) throws FixedLengthException {
    return this.parseAsStream(new BufferedReader(new InputStreamReader(stream)))
        .collect(Collectors.toList());
  }

  public Stream<Object> parseAsStream(BufferedReader reader) throws FixedLengthException {
  ...
  private static class FixedFormatRecord {
    private final String rawLine;
    private final FixedFormatLine fixedFormatLine;
    private FixedFormatRecord(String rawLine, FixedFormatLine fixedFormatLine) {
